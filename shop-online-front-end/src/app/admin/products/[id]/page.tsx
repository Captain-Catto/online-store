...
const ProductDetailPage: FC = () => {
  ...
  const formatProductData = (
    ...
    return {
      ...
      category: productData.categories[0]?.id || 0,
  ...
  const handleSaveBasicInfo = async (): Promise<void> => {
    ...
    try {
      const basicInfoData = {
        ...
        categories: [parseInt(String(product.category), 10)],
      };
        ...
        <div className="container-fluid">
          ...
          <div className="card">
            ...
            <div className="card-body">
              <div className="row">
                {/* Nội dung của phần tổng quan - columnLeft */}
                ...
                {/* Nội dung của phần tổng quan - columnRight */}
                <div className="col-md-6">
                  <table className="table table-striped">
                    <tbody>
                      <tr>
                      ...
                      <div>
                        ...
                        {isEditingBasicInfo && (
                          <small className="form-text text-muted">
                            ...
                            Để thêm/sửa màu sắc, vui lòng chuyển đến tab
                            &quot;Biến thể&quot;
                          </small>
                        )}
                      </div>
                    ...
                    <div className="col-md-6 form-group">
                      ...
                      <div>
                        ...
                        {isEditingBasicInfo && (
                          <small className="form-text text-muted">
                            <i className="fas fa-info-circle mr-1"></i>
                            Để thêm/sửa kích thước, vui lòng chuyển đến tab
                            &quot;Biến thể&quot;
                          </small>
                        )}
                      </div>
