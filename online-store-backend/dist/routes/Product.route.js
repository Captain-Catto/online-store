...
router.get("/:id/breadcrumb", Product_controller_1.getProductBreadcrumb);
...
// Basic info
router.patch("/:id/basic-info", authMiddleware_1.authMiddleware, (0, roleMiddleware_1.roleMiddleware)([1, 2]), Product_controller_1.updateProductBasicInfo);
// Inventory
router.patch("/:id/inventory", authMiddleware_1.authMiddleware, (0, roleMiddleware_1.roleMiddleware)([1, 2]), Product_controller_1.updateProductInventory);
// Add images
...
router.patch("/:id/variants", authMiddleware_1.authMiddleware, (0, roleMiddleware_1.roleMiddleware)([1, 2]), Product_controller_1.updateProductVariants);
